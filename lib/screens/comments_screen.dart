...
import 'package:finala/widgets/comment_card.dart';
...
class _CommentsScreenState extends State<CommentsScreen> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: 
        AppBar(backgroundColor: mobileBackgroundColor,
          ...
          child: Row(children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                style: TextStyle( color:Color.fromARGB(255, 22, 148, 252), fontSize:18),
